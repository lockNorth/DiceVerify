...
@ColumnWidth(25)
public class ReportForSicboDice {
    ...
    public ReportForSicboDice() {
    }

    public ReportForSicboDice(RequestJsonForm requestJsonForm) {
        List<DataSicbo> list = new ArrayList<>();
        for (DiceTestResult diceTestResult : requestJsonForm.getTxns()) {
            list.add(new DataSicbo(diceTestResult));
        }
        ...
        //計算骰子點數次數
        long[] pointsCount = MathUtils.getSicboDicePointsCount(list);
        //計算P_value
        ...
        //計算大小
        long[] bigSmallCount = MathUtils.getSicboDiceBigSmallCount(list);
        //計算大小P_value
        ...
        bigSmallPValue = MathUtils.getSicboDiceBigSmallPValue(bigSmallCount);
